...
/**/ 
export function xyz_color(x: num, y: num, z?: num) {
...
/**/ export function init(phosphor_red: num[] = SRGB_Red, phosphor_green: num[] = SRGB_Green, phosphor_blue: num[] = SRGB_Blue, white_point: num[] = SRGB_White) {
...
/**/ 
export function rgb_from_xyz(xyz: num[]) {
	return mult(rgb_from_xyz_matrix, xyz);
};
/**/ 
export var xyz_from_rgb = function (rgb: num[]) {
...
export function irgb_from_xyz(xyz: num[]) {

...
namespace internal {
    ...
    function makeBeaker(x=250, y=250, w=270, h=350, thick=40) {
        let beakerLeft = Bodies.rectangle(x, y, thick, h, { ignoreGravity: true, } as any) as PhysicsHook;
        let beakerRight = Bodies.rectangle(x + w, y, thick, h, { ignoreGravity: true } as any) as PhysicsHook;
        // let rect1 = Bodies.rectangle(300, 300, 200, 40, { ignoreGravity: true } as any) as PhysicsHook;
        let beakerFloor = Bodies.rectangle(x + w / 2, y + h / 2 - thick / 2, w, thick, { ignoreGravity: true } as any) as PhysicsHook;
